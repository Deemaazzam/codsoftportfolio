  ...
  return (
    <nav className={
     `${styles.paddingX} w-full items-center py-5 fixed top-0 z-20 bg-primary`
        ...
        <div className=" w-full flex justify-between items-center  max-w-7xl mx-auto " style={{
          display:'flex',
          ...
          gap:10
            ...
            window.scrollTo(0,0)}}>
              ...
              <p className='text-white text-[18px] font-bold cursor-pointer flex' >Dima Azzam|
               <span className='sm:block hidden '>Web Developer </span>
               </p>
               <ul className='list-none hidden sm:flex flex-row flex-1 justify-end gap-10'>
                {navLinks.map((link)=>(
               ...
               <div className='sm:hidden flex flex-1 justify-end items-center'>
                ...
                <div className={`${!toggle?'hidden':'flex'} p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
                      <ul className='list-none  flex justify-end items-start flex-col gap-4'  style={{ display: 'flex', justifyContent: 'space-between' }}>
                      {navLinks.map((link)=>(
